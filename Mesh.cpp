...
Mesh::Mesh(Vertex* _vertices, int _numVertices, unsigned int _indices[], int _numIndices, Microsoft::WRL::ComPtr<ID3D11Device> _device)
{
	//calculate tangents
	CalculateTangents(_vertices, _numVertices, _indices, _numIndices);
	//create the buffers 
	CreateBuffers(_vertices, _numVertices, _indices, _numIndices, _device);
}
...
Mesh::Mesh(const char* fileName, Microsoft::WRL::ComPtr<ID3D11Device> _device)
{
	...
	CreateBuffers(&verts[0], vertCounter, &indices[0], vertCounter, _device);
}
...
void Mesh::CreateBuffers(Vertex* _vertices, int _numVertices, unsigned int _indices[], int _numIndices, Microsoft::WRL::ComPtr<ID3D11Device> _device)
{
	//Store index count
